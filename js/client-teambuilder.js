		...
		arrangeCallback: {
			pokemon: function(pokemon) {
				if (!pokemon) {
					...
					// return ['OU','Limbo','Uber','BL','UU','BL2','RU','BL3','NU','Unreleased','Limbo NFE','NFE','LC Uber','LC','CAP','Lab','Uranium'];
					return ['OU','Uber','BL','Limbo A','Limbo B','Limbo C','Limbo','NFE','LC Uber','LC','Unreleased','CAP','Lab','Uranium'];
				}
